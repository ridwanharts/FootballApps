...
class PreviousMatchAdapter(private val dataItems: MutableList<Match>,
                           private val listener: PreviousMatchFragment.OnFragmentInteractionListener?): RecyclerView.Adapter<PreviousMatchAdapter.ViewHolder>(){
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        fun bindItem(item: Match, listener: PreviousMatchFragment.OnFragmentInteractionListener?){
